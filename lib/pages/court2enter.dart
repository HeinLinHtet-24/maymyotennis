...
class court2enter extends StatefulWidget {
  const court2enter({Key? key}) : super(key: key);

  @override
  State<court2enter> createState() => _court2enterState();
}

class _court2enterState extends State<court2enter> {
            ...
            Positioned(
              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => ingame2()),
                  );
                },
                child: Text('START'),
              ),
